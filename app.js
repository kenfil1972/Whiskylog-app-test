...
function render(){renderPickers();renderHome();renderBaseList();renderAllBottleLists();}
...
function renderHome(){
  document.getElementById('totalCost').textContent=formatPrice(state.bottles.reduce((s,b)=>s+parseDecimal(b.price),0));
    ...
    <div class="card detail-hero">${thumb(base)}
      <div>
        ...
        <div class="tags">
          ...
          <span class="pill">${formatPrice(b.price)}</span>
    ...
    <div class="grid two">
      ...
      <div class="card"><h3>Actions</h3>
        <div class="side" style="justify-content:flex-start;margin-top:8px">
          ...
          <button class="smallbtn" onclick="markEmpty('${id}')">Mark empty</button>
